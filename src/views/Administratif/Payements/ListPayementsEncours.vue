    ...
    <section class="py-1 bg-blueGray-50 my-5">
        <div class="w-full lg:w-11/12 px-4 mx-auto mt-6">
            <div
                ...
                <h6 class="text-blueGray-700 text-xl font-bold p-3">Liste Paiements en Cours</h6>
...
export default {
    ...
    methods: {
        ...
        async getAllPeriods() {
            try {
                const response = await axiosClient.get(`/administratif/eleves-services-period/bystatus/paiements en cours`);
